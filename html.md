...
下面是常见标签语义,更详细的可以参考： [semantic-html](http://justineo.github.io/slideshows/semantic-html/#/)
...
#### [强制] 使用 `HTML5` 的 `doctype` 来启用标准模式，建议使用大写的 `DOCTYPE`，在文档doctype申明之前，不允许加上任何非空字符；
